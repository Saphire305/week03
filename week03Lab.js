...
//Step 6:
console.log(array1[array1.length - 1]); //It did indeed change and I was able to grab the new last item.
...
// Step 2:
myTodoList.push(`Dishes`, `Shopping`, `Take Ryker on a ride on the Four Wheeler`);
console.log(myTodoList);
...
// Step 4:
let yourTodoList = [`Clean`, `Do Homework`];
...
console.log(reverse([`Dylan`, `Emily`, `Ryker`]));
